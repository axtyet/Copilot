...
class PersonIndexView extends StatelessWidget {
  const PersonIndexView({super.key, this.active = false});
  final bool active;
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('person-index'),
                        controller:
