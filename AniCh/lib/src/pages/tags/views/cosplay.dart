...
class TagsCosplayView extends StatelessWidget {
  const TagsCosplayView({super.key, this.active = false});
  final bool active;
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('tags-cosplay'),
                        controller:
