...
class TagsArtworkView extends StatelessWidget {
  const TagsArtworkView({super.key, this.active = false});
  final bool active;
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('tags-artwork'),
                        controller:
