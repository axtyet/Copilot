...
class HomeArtworkView extends StatelessWidget {
  const HomeArtworkView({super.key, this.active = false});
  final bool active;
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('home-artwork'),
                        controller:
