...
class HomeCosplayView extends StatelessWidget {
  const HomeCosplayView({super.key, this.active = false});
  final bool active;
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('home-cosplay'),
                        controller:
