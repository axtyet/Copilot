...
class ThreadAllCollectionView extends StatelessWidget {
  const ThreadAllCollectionView({super.key, this.active = false});
  final bool active;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: ThreadAllCollectionController(),
        builder: (controller) {
          return SafeArea(
            top: false,
            bottom: false,
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('thread-collection-all'),
                        controller:
