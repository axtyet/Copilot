...
class ThreadCosplayCollectionView extends StatelessWidget {
  const ThreadCosplayCollectionView({super.key, this.active = false});
  final bool active;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: ThreadCosplayCollectionController(),
        builder: (controller) {
          return SafeArea(
            top: false,
            bottom: false,
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('thread-collection-cosplay'),
                        controller:
