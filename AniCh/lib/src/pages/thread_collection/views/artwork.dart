...
class ThreadArtworkCollectionView extends StatelessWidget {
  const ThreadArtworkCollectionView({super.key, this.active = false});
  final bool active;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: ThreadArtworkCollectionController(),
        builder: (controller) {
          return SafeArea(
            top: false,
            bottom: false,
                  ...
                  child: controller.obx(
                    (state) {
                      return CustomScrollView(
                        key: const PageStorageKey('thread-collection-artwork'),
                        controller:
