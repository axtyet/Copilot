...
class BangumiWatchedCollectionView extends StatelessWidget {
  const BangumiWatchedCollectionView({super.key, this.active = false});
  final bool active;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: BangumiWatchedCollectionController(),
        builder: (controller) {
          return SafeArea(
            top: false,
            bottom: false,
                  ...
                  child: controller.obx(
                    (state) {
                      return Stack(
                        children: [
                          CustomScrollView(
                            key: const PageStorageKey('bangumi-watched'),
                            controller:
