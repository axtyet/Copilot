...
class BangumiWatchCollectionView extends StatelessWidget {
  const BangumiWatchCollectionView({super.key, this.active = false});
  final bool active;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: BangumiWatchCollectionController(),
        builder: (controller) {
          return SafeArea(
            top: false,
            bottom: false,
                  ...
                  child: controller.obx(
                    (state) {
                      return Stack(
                        children: [
                          CustomScrollView(
                            key: const PageStorageKey('bangumi-watch'),
                            controller:
